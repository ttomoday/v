...
!function(e){"use strict";e.srSmoothscroll=function(t){var n,o=e.extend({step:60,speed:250,ease:"swing",target:e("body"),container:e(window)},t||{}),r=o.container,i=0,s=o.step,a=r.height(),c=!1;n="body"==o.target.selector?-1!==navigator.userAgent.indexOf("AppleWebKit")?o.target:e("html"):r,o.target.mousewheel(function(e,t){return c=!0,i=0>t?i+a>=o.target.outerHeight(!0)?i:i+=s:0>=i?0:i-=s,n.stop().animate({scrollTop:i},o.speed,o.ease,function(){c=!1}),!1}),r.on("resize",function(){a=r.height()}).on("scroll",function(){c||(i=r.scrollTop())})}}(jQuery);
